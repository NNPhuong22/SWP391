 ...
 * @author vuntd
 */
public class RegistrationStatusController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            SubjectRegister sr = rdao.getRegistrationById(Integer.parseInt(srid));
            rdao.ChangeRegistratiionStatus(sr);
