<%-- 
    Document   : detail
    Created on : Oct 16, 2021, 1:39:39 AM
    Author     : hieu phan
--%>
    ...
    <%@page import="Enitity.Price"%>
        <%@page import="Enitity.Subject"%>
            <%@page import="Enitity.User"%>
               ...
               Price c = (Price) request.getAttribute("price");
               String dublicateSubject = (String) request.getAttribute("dublicateSubject");
            %>
                                ...
                                <div class="row">
                                    <div class="col-md-5">
                                        ...
                                        <div class="project-info-box">
                                            ...
                                            <p class="mb-0"><b>Budget:</b>
                                                <%=c.getPrice() %>
                                                    <%=c.getCurrency_unit() %>
                                            </p>
                                        </div>
                                        <!-- / project-info-box -->
                                        <% if(dublicateSubject==null){ %>
                                            <button style="width:100%;" class="btn btn-success"><a href="SubjectDetail?type=registed&subID=<%=s.getS_id() %>" style="text-decoration: none!important; color: white!important;">Register Now</a></button>
                                            <% } else {%>
                                                <button style="width:100%;" class="btn btn-success" disabled="true">Registered</button>
                                                <% } %>
                                    </div>
                                    <!-- / column -->

                                    <div class="col-md-7">
                                        <img src="<%=s.getImage() %>" alt="project-image" class="rounded">
