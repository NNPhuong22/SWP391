...
<html lang="en">
  <head>
    ...
    />
    <!-- CSS Core -->
    <link rel="stylesheet" href="${path}/asset/css/about.css" />
  </head>
  <body>
      <!--Navigation-->
        ...
        <div class="container px-5 my-5">
            ...
            <div class="row gx-5 row-cols-1 row-cols-sm-2 row-cols-xl-4 justify-content-center">
                <div class="col mb-5 mb-5 mb-xl-0">
                    <div class="text-center">
                        <img class="img-mem img-fluid rounded-circle mb-4 px-4" src="https://dummyimage.com/150x150/ced4da/6c757d" alt="..." />
